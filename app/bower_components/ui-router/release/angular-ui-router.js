...
function $ViewScrollProvider() {
   ...
   *
   * @description
   * Reverts back to using the core [`$anchorScroll`](http://docs.angularjs.org/controllers/ng.$anchorScroll) service for
 ...
 *
 * *Note: To revert back to old [`$anchorScroll`](http://docs.angularjs.org/controllers/ng.$anchorScroll)
